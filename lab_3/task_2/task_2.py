...
def main():
    ...
    questions_path = os.path.join("lab_3","task_2","questions.txt")
    answers_path = os.path.join("lab_3","task_2","answers.txt")
    ...
    handler = LanguageModel(model_name=model_name)
...
# Default
# Evaluation Complete: 138/1000 correct answers.
# Accuracy: 13.80%
